  ...
  const generateGridCells = () => {
    ...
    for (let row = 0; row < rows; row++) {
      for (let col = 0; col < cols; col++) {
        const isPink = heroConfig.pinkCells.some(
        ...
        <div className="relative w-full max-w-6xl px-6">
          ...
          {heroConfig.titleLine1 && (
            <div className="flex justify-start mb-4">
              <div className="title-block bg-gradient-to-r from-[#F7A8B8] to-[#FFD1DC] px-8 py-4 pointer-events-auto hover:scale-110 transition-transform duration-300">
                <span className="font-display font-black text-6xl md:text-8xl lg:text-9xl text-[#8B1C3D] tracking-tighter">
                  {heroConfig.titleLine1}
                </span>
              </div>
            </div>
