...
const ProductShowcase = () => {
  ...
  if (!productShowcaseConfig.productName && !productShowcaseConfig.headingMain)
    return null;
    ...
    >
      ...
      <div className="relative z-10 w-full px-6 lg:px-12">
        ...
        <div className="mb-16">
          ...
          {(productShowcaseConfig.headingMain ||
            productShowcaseConfig.headingAccent) && (
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          <div className="relative flex items-center justify-center">
            ...
            >
              ...
              <div
                className="absolute -bottom-4 -left-4 text-pink animate-float"
            ...
            {productShowcaseConfig.features.length > 0 && (
              <div className="grid grid-cols-2 gap-6">
                {productShowcaseConfig.features.map((feature, index) => (
                  <div
                    key={index}
                    className="border border-white/10 p-6 hover:border-pink transition-colors duration-300"
                  >
                    <div className="text-pink font-display font-black text-3xl mb-2">
                      {feature.value}
                    </div>
